...
sidecar download directory to `SUPPORT_ASSET_ALLOWED_LOCAL_DIRS` in the Python
service environment. Remote media URLs are rejected unless their HTTPS host is
listed in `SUPPORT_ASSET_ALLOWED_URL_HOSTS`.
